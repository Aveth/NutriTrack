...
class CDContextProvider {

    static private let errorDomain: String = "com.aveth.NutriTrack.CoreDataContextProvider"
    
    static internal var sharedProvider: CDContextProvider = CDContextProvider()
    ...
    lazy private var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        do {
            ...
            let wrappedError = NSError(domain: CDContextProvider.errorDomain, code: 9999, userInfo: dict)
